    ...
    return (
        <div className="bg-card border border-border rounded-xl p-5 h-[380px] animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-base font-semibold text-foreground">Xu hướng doanh thu</h3>
                    <p className="text-sm text-muted-foreground mt-0.5">Hiệu suất hàng tháng so với mục tiêu</p>
                </div>
